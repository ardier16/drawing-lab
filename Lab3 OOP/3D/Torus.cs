...
namespace Lab3_OOP
{
    ...
    {
        public Torus(Pen p, SolidBrush s, double x, double y, double z, int r, int h) : base(p, x, y, z, r, h) 
        {
            this.FBrush = s;
        }
        ...
        public override void Draw(Graphics g)
        {
            ...
            g.DrawEllipse(new Pen(Color.White), (float)(this.X - this.Radius + this.Height/2), (float)(this.Y - this.Radius + this.Height*0.15),
